...
bi_mcmc_file = '../data/bias_chain_fd1_case3_er.txt'
...
plt.errorbar(z_obs0,mu_obs0,yerr=sig_mu_obs0,marker=".",ms=6,fmt='.k',alpha=0.2,elinewidth=1)
...
plt.subplot(2,2,4)
plt.errorbar(z_obs2,mu_obs2-mu_w_vectorized(z_obs2,0.31,67.74,-1),yerr=sig_mu_obs2,
             marker="v",ms=6,fmt='.r',alpha=0.2,elinewidth=1)
plt.errorbar(z_obs1,mu_obs1-mu_w_vectorized(z_obs1,0.31,67.74,-1),yerr=sig_mu_obs1,
...
plt.tight_layout()
plt.savefig('../figures/bias_subplots_fd1_case3_er.png')
plt.close()
...
plt.title(r'$\rm{MCMC\ Contours\ Case\ 3}$',fontsize=15)#,y=1.02)
plt.ylabel(r'$w$',fontsize=14)
plt.xlabel('$\Omega_M$',fontsize=14)
plt.ylim([-2.5,0])
...
plt.savefig('../figures/bias_contour_fd1_case3_er.png')
plt.close()