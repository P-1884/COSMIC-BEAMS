...
bi_mcmc_file = '../data/bias_chain_fd1_case2.2_'+erm+'_er.txt'
...
plt.tight_layout()
plt.savefig('../figures/bias_subplots_fd1_case2.2_'+erm+'_er.png')
plt.close()
...
plt.title(r'$\rm{MCMC\ Contours\ Case\ 2.2c}$',fontsize=15)#,y=1.02)
plt.ylabel(r'$w$',fontsize=14)
plt.xlabel('$\Omega_M$',fontsize=14)
plt.ylim([-2.5,0])
...
plt.savefig('../figures/bias_contour_fd1_case2.2_'+erm+'_er.png')
plt.close()
