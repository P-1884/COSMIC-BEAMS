...
nb_mcmc_file = 'mcmc_chain_nb_b0.txt'
bi_mcmc_file = 'mcmc_chain_bi_b0.txt'
zb_mcmc_file = 'mcmc_chain_bi_b1.txt'
...
N100_nb,N95_nb,N68_nb,X_nb,Y_nb,Z_nb = contour(c_nb,[0,1],labels=['1','2'],smooth=51e5,line=True)
N100_bi,N95_bi,N68_bi,X_bi,Y_bi,Z_bi = contour(c_bi,[0,1],labels=['1','2'],smooth=20e4,line=False)
N100_zb,N95_zb,N68_zb,X_zb,Y_zb,Z_zb = contour(c_zb,[0,1],labels=['1','2'],smooth=16e4,line=False)
...
patch8 = mpatches.Patch(color=col1[0], label=r'$\rm{Biased}$')
...
plt.hist(om_bi,bins=70,normed=True,color=col1[0],alpha=0.6)
...
plt.savefig('contours_photometric.png')
plt.close()